...
class _PaymentSuccessPageState extends State<PaymentSuccessPage> with SingleTickerProviderStateMixin {
                ...
                child: SafeArea(
                  child: Column(
                    children: [
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  ts.translate('payment_activated_desc'),
                                  textAlign: TextAlign.center,
                      ...
                      _buildBottomButtons(context, primaryColor, mutedForeground, ts),
                    ],
                  ),
                ),
              ),
        ...
        AnimatedBuilder(
          ...
          builder: (context, child) {
            return Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                border: Border.all(color: primaryColor.withOpacity(0.2 * (1 - _controller.value))),
              ),
            );
          },
        ),
  ...
  Widget _buildDetailsCard(Color primaryColor, Color mutedForeground, Color cardColor, Color borderColor, TranslationService ts) {
    return Container(
      ...
      child: Column(
        children: [
          _buildDetailRow(ts.translate('transaction_id'), '#CT-9920144', primaryColor, mutedForeground, isMono: true),
          const Padding(
            padding: EdgeInsets.symmetric(vertical: 16),
            child: Divider(color: Colors.white10, height: 1),
          ),
          _buildDetailRow(ts.translate('service_fee'), ts.formatPrice(30000), Colors.white, mutedForeground, isBold: true),
          const Padding(
            padding: EdgeInsets.symmetric(vertical: 16),
            child: Divider(color: Colors.white10, height: 1),
          ),
  ...
  Widget _buildBottomButtons(BuildContext context, Color primaryColor, Color mutedForeground, TranslationService ts) {
    return Padding(
