...
class _LanguageSelectionPageState extends State<LanguageSelectionPage> {
                ...
                children: [
                    ...
                    child: Column(
                      children: [
                        _buildLanguageOption(
                          'English',
                          selectedLanguage == 'English' ? 'Current Selection' : 'Optional',
                        ...
                        _buildLanguageOption(
                          'Français',
                          selectedLanguage == 'Français' ? 'Sélection actuelle' : 'Optionnelle',
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ts.setLanguage(selectedLanguage);
  ...
  Widget _buildLanguageOption(String title, String subtitle, String flagUrl, Color primaryColor, Color cardColor) {
